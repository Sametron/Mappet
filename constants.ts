...
// The background for the final ending screen
export const ENDING_BACKGROUND_URL: string = '/images/endbg.jpg';

// Image for the final ending screen
export const END_RESULT_IMAGE_URL: string = '/images/endresult.png';
