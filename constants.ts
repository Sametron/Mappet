...
export const BACKGROUND_URL: string = '/images/map.png'; // A square fantasy map background

// The background for the 'Mission Briefing' start screen
export const START_SCREEN_BACKGROUND_URL: string = '/images/startbg.png'; // A dark, abstract, tech-focused background

// New configuration object for the loading GIF
export const LOADING_GIF_CONFIG: LoadingGifConfig = {
  url: '/images/animatedloader.gif',
...
export const HEADER_LOGO_CONFIG: HeaderLogoConfig = {
  url: '/images/logo.png', // A simple, white abstract logo
...
export const ISLAND_CONFIGS: IslandConfig[] = [
  { 
    ...
    undevelopedImg: '/images/Land01_empty.png',
    activeImg: '/images/Land01_active.gif',
    developedImg: '/images/Land01_developed.png',
    cardImg: '/images/Card01.png', // 01
    promptQuestion: '% of outpatient visits out-of-pocket?'
  },
  { 
    ...
    undevelopedImg: '/images/Land02_empty.png',
    activeImg: '/images/Land02_active.gif',
    developedImg: '/images/Land02_developed.png',
    cardImg: '/images/Card02.png', // 02
    promptQuestion: '# clinics we will have under Big5?'
  },
   { 
    ...
    undevelopedImg: '/images/Land03_empty.png',
    activeImg: '/images/Land03_active.gif',
    developedImg: '/images/Land03_developed.png',
    cardImg: '/images/Card03.png', // 03
    promptQuestion: 'Market share of top five HS players combined?'
  },
  { 
    ...
    undevelopedImg: '/images/Land04_empty.png',
    activeImg: '/images/Land04_active.gif',
    developedImg: '/images/Land04_developed.png',
    cardImg: '/images/Card04.png', // 04
    promptQuestion: 'Who has biggest influence on hospital choice?'
  },
  {
    ...
    undevelopedImg: '/images/Land05_empty.png',
    activeImg: '/images/Land05_active.gif',
    developedImg: '/images/Land05_developed.png',
    cardImg: '/images/Card05.png', // 05
    promptQuestion: 'Our data density % to date?'
  },
    { 
    ...
    undevelopedImg: '/images/Land06_empty.png',
    activeImg: '/images/Land06_active.gif',
    developedImg: '/images/Land06_developed.png',
    cardImg: '/images/Card06.png', // 06
    promptQuestion: 'Our profit ambition?'
  },
